...
export const Hero: React.FC = () => {
    return (
        <section className="min-h-screen flex flex-col justify-center px-6 lg:px-20 py-20 relative overflow-hidden">
            ...
            <div className="max-w-4xl z-10">
                <motion.p
                    ...
                    className="text-neon-cyan font-mono text-sm tracking-widest mb-6"
                >
                    Hello, I'm
                </motion.p>

            ...
            <div className="max-w-5xl mx-auto flex flex-col gap-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex items-center gap-4">
                        <span className="text-xl font-bold text-white tracking-tight">{profile.nickname.toUpperCase()}<span className="text-neon-cyan">.</span></span>
                ...
                <div className="text-white/50 text-xs font-mono text-center pt-8 border-t border-white/5">
